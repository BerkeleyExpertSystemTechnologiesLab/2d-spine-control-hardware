...
(cl:defmethod cl:initialize-instance :after ((m <ShouldersGaitCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ShouldersGaitCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name belka_gait_commander-msg:<ShouldersGaitCommand> is deprecated: use belka_gait_commander-msg:ShouldersGaitCommand instead.")))

(cl:ensure-generic-function 'shoulders_command-val :lambda-list '(m))
(cl:defmethod shoulders_command-val ((m <ShouldersGaitCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader belka_gait_commander-msg:shoulders_command-val is deprecated.  Use belka_gait_commander-msg:shoulders_command instead.")
  (shoulders_command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ShouldersGaitCommand>)))
  ...
  "belka_gait_commander/ShouldersGaitCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ShouldersGaitCommand)))
  "Returns string type for a message object of type 'ShouldersGaitCommand"
  "belka_gait_commander/ShouldersGaitCommand")
