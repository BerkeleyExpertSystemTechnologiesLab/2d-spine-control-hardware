...
(cl:defmethod cl:initialize-instance :after ((m <HipsGaitCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HipsGaitCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name belka_gait_commander-msg:<HipsGaitCommand> is deprecated: use belka_gait_commander-msg:HipsGaitCommand instead.")))

(cl:ensure-generic-function 'hips_command-val :lambda-list '(m))
(cl:defmethod hips_command-val ((m <HipsGaitCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader belka_gait_commander-msg:hips_command-val is deprecated.  Use belka_gait_commander-msg:hips_command instead.")
  (hips_command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HipsGaitCommand>)))
  ...
  "belka_gait_commander/HipsGaitCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HipsGaitCommand)))
  "Returns string type for a message object of type 'HipsGaitCommand"
  "belka_gait_commander/HipsGaitCommand")
